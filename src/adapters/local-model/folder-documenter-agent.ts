...
export function folderDocumenterArtifactInstruction(
  ...
  if (artifact === "project-overview.md") {
    return category === "project"
      ...
      : "Write only the experience overview content. Begin exactly with '# Experience Overview (Proposed / Unreviewed)'. State the documented role or organization context, assignment, concrete work outputs, collaboration/process evidence, and direct evidence gaps in at most eight concise bullets.";
  }
  return category === "project"
    ? "Write only resume-summary.md. Begin exactly with '# Resume Summary (Proposed / Unreviewed)'. Provide a complete factual project handoff for a resume specialist: project identity, the directly evidenced problem or purpose, intended user or workflow when stated, design rationale that connects implementation choices to that workflow, material capabilities, directly evidenced implementation scope, directly stated outcomes, and explicit attribution or impact gaps. Keep implementation mechanisms subordinate to why they matter. If purpose, users, rationale, or outcomes are not directly established, say so plainly. Do not impose a sentence, paragraph, or bullet count. Do not write candidate-facing resume bullets, source paths, configuration values, commands, routes, or setup instructions."
    : "Write only resume-summary.md. Begin exactly with '# Resume Summary (Proposed / Unreviewed)'. Provide a concise, high-density factual work-experience handoff for a resume specialist: verified role/organization/period where present, responsibilities, outputs, collaboration/process evidence, explicitly stated outcomes, and attribution or impact gaps. Be concise, technical, and dense without daily narrative filler. Do not write candidate-facing resume bullets.";
}
