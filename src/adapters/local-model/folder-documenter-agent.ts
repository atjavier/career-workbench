...
export function folderDocumenterArtifactInstruction(
  ...
  return category === "project"
    ...
    : "Write only resume-summary.md. Begin exactly with '# Resume Summary (Proposed / Unreviewed)'. Provide a complete factual work-experience handoff for a resume specialist: verified role/organization/period where present, responsibilities, outputs, collaboration/process evidence, explicitly stated outcomes, and attribution or impact gaps. Do not impose a sentence, paragraph, or bullet count. Do not write candidate-facing resume bullets.";
}
