...
export const migrations = [
  ...
  { id: "0030_resume_evidence_intake", sql: readFileSync(join(migrationDirectory, "0030_resume_evidence_intake.sql"), "utf8") },
  { id: "0031_resume_evidence_interpretations", sql: readFileSync(join(migrationDirectory, "0031_resume_evidence_interpretations.sql"), "utf8") },
  { id: "0032_resume_evidence_interpretation_contradictions", sql: readFileSync(join(migrationDirectory, "0032_resume_evidence_interpretation_contradictions.sql"), "utf8") },
  { id: "0033_resume_workspace_journeys", sql: readFileSync(join(migrationDirectory, "0033_resume_workspace_journeys.sql"), "utf8") },
  { id: "0034_backfill_resume_workspace_journeys", sql: readFileSync(join(migrationDirectory, "0034_backfill_resume_workspace_journeys.sql"), "utf8") },
  { id: "0035_resume_workspace_journey_fingerprint", sql: readFileSync(join(migrationDirectory, "0035_resume_workspace_journey_fingerprint.sql"), "utf8") },
  { id: "0036_resume_clarification_task_responses", sql: readFileSync(join(migrationDirectory, "0036_resume_clarification_task_responses.sql"), "utf8") },
  { id: "0037_resume_clarified_evidence", sql: readFileSync(join(migrationDirectory, "0037_resume_clarified_evidence.sql"), "utf8") },
  { id: "0038_resume_evidence_packets", sql: readFileSync(join(migrationDirectory, "0038_resume_evidence_packets.sql"), "utf8") },
  { id: "0039_resume_interview_turns", sql: readFileSync(join(migrationDirectory, "0039_resume_interview_turns.sql"), "utf8") },
  { id: "0040_resume_interview_candidate_turns", sql: readFileSync(join(migrationDirectory, "0040_resume_interview_candidate_turns.sql"), "utf8") },
  { id: "0041_resume_interview_stream_attempts", sql: readFileSync(join(migrationDirectory, "0041_resume_interview_stream_attempts.sql"), "utf8") },
  { id: "0042_resume_interview_stream_reservations", sql: readFileSync(join(migrationDirectory, "0042_resume_interview_stream_reservations.sql"), "utf8") },
] as const;
