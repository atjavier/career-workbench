...
export function JobListings({ opportunities, error }: { opportunities: CapturedOpportunityLibraryItem[]; error?: { summary: string; safeNextAction: string } }) {
