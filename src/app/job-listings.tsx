    ...
    >
      <header className="jobs-workspace-header">
        <div>
          ...
          <p>
            Keep the roles you choose to capture in one calm, private workspace.
            You decide what to save and when to open the original page.
          </p>
        </div>
      ...
      {jobsView === "applied" ? (
        <section className="jobs-empty-state" aria-labelledby="applied-heading">
          ...
          <h3 id="applied-heading">
            Applied opportunities are not available yet
          </h3>
          <p>
            Application tracking is a later local workflow. Your captured
            opportunities remain available in All opportunities.
          </p>
          <button
            type="button"
        ...
        <section className="jobs-results" aria-label="Captured opportunities">
          ...
          {opportunities.length > 0 ? (
            <p className="jobs-result-summary" role="status" aria-live="polite">
              {filteredOpportunities.length} matching captured opportunit
          ...
          {opportunities.length === 0 ? (
            <section className="jobs-empty-state jobs-library-empty">
              ...
              <p>
                Captured opportunities appear here after you review and confirm
                copied role details. You stay in control of the URL and text you
                provide.
              </p>
              <button
                className="affirmative-action add-opportunity-action"
            ...
            <div className="jobs-empty-state">
              <p>
                No captured opportunities match your search. Clear search and
                try again.
              </p>
              <button
                type="button"
          ...
          <div className="job-listing-actions">
            ...
            <p className="job-source">
              ...
              >
                ...
                <span aria-hidden="true" className="external-icon">
                  ↗
                </span>
              </a>
