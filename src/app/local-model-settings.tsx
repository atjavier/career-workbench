...
export function LocalModelSettings({ ready }: { ready: boolean }) {
  ...
  return <section className="panel local-model-settings" aria-labelledby="local-model-settings-heading">
    ...
    <p>Connect any loaded LLM in LM Studio on this computer (e.g. Qwen3.5-9B, Llama 3, GLM, or DeepSeek). This loopback-only connection does not use an API token.</p>
    ...
    <form action={action} aria-busy={pending}>
      ...
      <p id="local-model-help" className="field-help">Choose the exact identifier for a loaded model from LM Studio (such as Qwen3.5-9B or your model&apos;s key).</p>
