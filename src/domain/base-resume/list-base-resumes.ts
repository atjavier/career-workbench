...
export type BaseResumeListState =
  | { resumes: StoredBaseResume[]; error?: undefined }
  | { resumes: StoredBaseResume[]; error: WorkspaceError };
  ...
  try {
    ...
    return {
      ...
      error: new WorkspaceError(
        ...
        "Imported Base Resumes cannot be loaded right now.",
